...
class Config:
    ...
    radius, height, MaxVelo, MaxAcc = 0.47/(2**0.5), 0.11, 10.0, 10.0 #note: height here is the cylinder height
    ...
    r_alpha, h_alpha = 1.0, 1.16 #1.5 #height*3/2*6height*3/2 #0.57 0.74 @a=5
    r_alpha_max, r_alpha_min = r_alpha, 0.71
    h_alpha_max, h_alpha_min = h_alpha, 0.2
    ...
    c1, c2, RepulsiveGradient = 10.0, 10.0, 50.0 #*(10**3)
